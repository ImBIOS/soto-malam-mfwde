...
<div class="restaurant-item__header">
    <img class="lazyload" class="restaurant-item__header__poster" alt="${restaurant.name || "-"}"
        data-src="${restaurant.pictureId ? `${CONFIG.BASE_IMAGE_URL}small/${restaurant.pictureId}` : "https://images.unsplash.com/photo-1481833761820-0509d3217039?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80"}">
...
<div class="restaurant-item__content">
    ...
    <p>${restaurant.description ? truncate(restaurant.description) : "-"}</p>
</div>
</div>
`;
